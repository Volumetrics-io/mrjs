...
export function mobileCheckFunction() {
    ...
    const userAgentRegex0 = new RegExp('(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|\
        ...
        up\.(browser|link)|vodafone|wap|windows ce|xda|xiino', 'is');
    const userAgentRegex1 = new RegExp('/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|\
        ...
        mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|\
        ...
        wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-', 'is');
