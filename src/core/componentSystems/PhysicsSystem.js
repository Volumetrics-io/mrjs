...
export class PhysicsSystem extends MRSystem {
    ...
    updateBody(entity) {
        ...
        if ((entity.compStyle.visibility == 'hidden' || (entity.compStyle.pointerEvents == 'none' && !this.app.inspect)) && entity.physics.body.isEnabled()) {
            entity.physics.body.setEnabled(false);
        } else if (!entity.physics.body.isEnabled() && entity.compStyle.visibility == 'visible' && (entity.compStyle.pointerEvents != 'none' || this.app.inspect)) {
